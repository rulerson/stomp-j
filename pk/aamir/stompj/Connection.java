...
public class Connection {
    ...
    // temporary comment off
    private void subscribe(String destination, boolean autoAck) {
    ...
    private void unsubscribe(String destination, HashMap<String, String> optionalHeaders) {
